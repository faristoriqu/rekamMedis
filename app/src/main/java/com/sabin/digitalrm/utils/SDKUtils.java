...
public class SDKUtils {
    ...
    public static boolean processUnsupportedException(final AppCompatActivity activity, SsdkUnsupportedException e) {
        e.printStackTrace();
    ...
    private static void showAlertDialog(final AppCompatActivity activity, String msg, final boolean closeActivity) {
