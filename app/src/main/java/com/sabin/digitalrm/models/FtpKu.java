...
public class FtpKu {
    ...
    public boolean ftpConnect(String host, String username, String password, int port, String srcFilePath, String desFileName,
                              String desDirectory) {
        try {
...
//            mFTPClient.sendCommand("OPTS UTF8 ON");
            ...
            if (FTPReply.isPositiveCompletion(mFTPClient.getReplyCode())) {
                ...
                Log.e("Connect = ", String.valueOf(status));
...
//                mFTPClient.enterLocalPassiveMode();
                Log.e("file upload", srcFilePath);
//                String dir = ftpGetCurrentWorkingDirectory();
                try {
                    boolean upload = ftpUpload( srcFilePath,  desFileName,
                            desDirectory);

                    if (upload){
                        Log.e("upload", String.valueOf(true));
                    }else{
                        Log.e("upload", String.valueOf(false));
                    }
                }catch (Exception e){
                    Log.e(TAG," exception upload"+e);
                }
//


//                Boolean rename = ftpRenameFile("Dockerfile","filedoker");
//
//                if (rename){
//                    Log.e("rename", String.valueOf(true));
//                }else{
//
//                    Log.e("rename", "failed!!");
//                }
//                Boolean newDir = ftpChangeDirectory("archives");
//                String[] files = ftpPrintFilesList("/archives");
//
//                if (files != null){
//
...
//                Log.e("newdir = ", String.valueOf(newDir));
    ...
    public String ftpGetCurrentWorkingDirectory() {
        try {
            ...
            Log.d(TAG, "Error: could not get current working directory."+e);
        }
    ...
    public boolean ftpRenameFile(String from, String to) {
        try {
            ...
            Log.d(TAG, "Could not rename file: " + from + " to: " + to+ "karena"+e);
        }
    ...
    /**
     * mFTPClient: FTP client connection object (see FTP connection example)
     * srcFilePath: source file path in sdcard des
     * FileName: file name to be stored in FTP server
    ...
    public boolean ftpUpload(String srcFilePath, String desFileName,
        ...
        try {
            ...
            if (mFTPClient.changeWorkingDirectory("/archives/"+desDirectory)) {
